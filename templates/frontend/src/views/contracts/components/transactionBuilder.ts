...
/**
 * Encodes function parameters for contract calls using the {{ORG_NAME}} backend
...
export const encodeParameters = async (
  ...
  try {
    Log('Encoding transaction parameters via {{ORG_NAME}} backend...');
    ...
    // Call the {{ORG_NAME}} backend Encode function which uses Function.Pack

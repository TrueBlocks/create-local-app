  ...
  switch (structured.type) {
    ...
    case 'sdk':
      if (
        ...
        return `{{ORG_NAME}} core is not properly installed or configured. Please check your installation.`;
      }
      ...
      return `Failed to ${operation} ${structured.dataFacet} data from {{ORG_NAME}}. Please try again or check your configuration.`;

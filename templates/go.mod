module github.com/{{ORG_NAME}}/{{SLUG}}

// GoLang version
go 1.23.8

require (
	{{CHIFRA}} v0.0.0-20250714224821-dc2de0c9095e
	github.com/{{ORG_NAME}}/{{ORG_LOWER}}-dalle/v2 v2.0.0-20250504164335-8b49b03dddef
	github.com/{{ORG_NAME}}/{{ORG_LOWER}}-sdk/v5 v5.3.1-0.20250718201602-b98a46481118

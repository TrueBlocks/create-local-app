...
import (
	...
	"github.com/{{ORG_NAME}}/{{SLUG}}/app"
	"github.com/{{ORG_NAME}}/{{SLUG}}/pkg/msgs"
	"github.com/{{ORG_NAME}}/{{SLUG}}/pkg/preferences"
	"github.com/{{ORG_NAME}}/{{SLUG}}/pkg/project"
	...
	"github.com/{{ORG_NAME}}/{{SLUG}}/pkg/types/exports"
	"github.com/{{ORG_NAME}}/{{SLUG}}/pkg/types/monitors"
	"github.com/{{ORG_NAME}}/{{SLUG}}/pkg/types/names"
	"github.com/{{ORG_NAME}}/{{SLUG}}/pkg/types/status"
